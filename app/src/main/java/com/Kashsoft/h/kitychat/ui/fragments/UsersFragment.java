...
import com.Kashsoft.h.kitychat.core.users.getall.GetUsersContract;
import com.Kashsoft.h.kitychat.core.users.getall.GetUsersPresenter;
import com.Kashsoft.h.kitychat.models.User;
import com.Kashsoft.h.kitychat.ui.activities.ChatActivity;
import com.Kashsoft.h.kitychat.ui.adapters.UserListingRecyclerAdapter;
import com.Kashsoft.h.kitychat.utils.ItemClickSupport;
...
public class UsersFragment extends Fragment implements GetUsersContract.View, ItemClickSupport.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
        ChatActivity.startActivity(getActivity(), mUserListingRecyclerAdapter.getUser(position).email,
