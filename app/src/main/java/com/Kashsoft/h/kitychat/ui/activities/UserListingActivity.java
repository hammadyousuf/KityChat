...
import com.Kashsoft.h.kitychat.core.logout.LogoutContract;
import com.Kashsoft.h.kitychat.core.logout.LogoutPresenter;
import com.Kashsoft.h.kitychat.ui.adapters.UserListingPagerAdapter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_logout:
                logout();
                // IF ADD MORE         //case R.id.abt:
                //Intent intent=new Intent(UserListingActivity.this, AboutActivity.class);
